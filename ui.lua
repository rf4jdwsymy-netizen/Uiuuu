...
local Success, Response = pcall(function()
    Icons = loadstring(game:HttpGet("https://raw.githubusercontent.com/m1kp0/BetterOrion/refs/heads/main/Icons.lua"))().assets
end)
...
local function MakeDraggable(DragPoint, Main)
    pcall(function()
        ...
        local function ToggleCameraLock(lock)
            if lock and not CameraLocked then
                pcall(function()
                    workspace.CurrentCamera.CameraType = Enum.CameraType.Scriptable
                    CameraLocked = true
                end)
            elseif not lock and CameraLocked then
                pcall(function()
...
function OrionLib:LoadCfg1(path)
    if type(path) == "string" and isfile(path) then
        local json = readfile(path)
        LoadCfg(json)
    else
        warn("Zalupa seb!:", path)
    end
end
function OrionLib:SaveCfg1(Name)
...
function OrionLib:Init()
    if OrionLib.SaveCfg then    
        pcall(function()
            if isfile(OrionLib.Folder .. "/" .. "AutoSave" .. ".txt") then
                LoadCfg(readfile(OrionLib.Folder .. "/" .. "AutoSave" .. ".txt"))
...
function OrionLib:MakeWindow(WindowConfig)
    ...
    local MainWindow = SetChildren(SetProps(MakeElement("TFrame"), {
        Parent = Orion,
        ...
        SetProps(Instance.new("UICorner"), {
        ...
        SetProps(Instance.new("UIGradient"), {
            ...
            Color = ColorSequence.new({
                ...
                ColorSequenceKeypoint.new(0.12, Color3.fromRGB(80, 100, 130)),
                ColorSequenceKeypoint.new(0.32, Color3.fromRGB(20, 28, 40)),
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(95, 120, 150)),
                ColorSequenceKeypoint.new(0.68, Color3.fromRGB(18, 24, 34)),
                ColorSequenceKeypoint.new(0.88, Color3.fromRGB(65, 82, 105)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(10, 14, 20))
            }),
            Transparency = NumberSequence.new({
                NumberSequenceKeypoint.new(0.00, 0.48),
                NumberSequenceKeypoint.new(0.20, 0.60),
        ...
        SetProps(Instance.new("UIStroke"), {
        ...
        SetChildren(SetProps(MakeElement("TFrame"), {
            ...
            SetProps(Instance.new("UIGradient"), {
                ...
                Transparency = NumberSequence.new({
                    ...
                    NumberSequenceKeypoint.new(0.38, 0.72),
        ...
        SetChildren(SetProps(MakeElement("TFrame"), {
            ...
            SetProps(Instance.new("UIGradient"), {
                ...
                Transparency = NumberSequence.new({
                    ...
                    NumberSequenceKeypoint.new(0.25, 0.94),
        ...
        SetProps(MakeElement("TFrame"), {
            Name = "SecondaryReflection",
            Size = UDim2.new(0, 500, 0, 2),
            Position = UDim2.new(0, -80, 0.72, 0),
            Rotation = -18,
        ...
        SetProps(MakeElement("TFrame"), {
            Name = "RightAccent",
            Size = UDim2.new(0, 1, 0, 120),
            Position = UDim2.new(1, -6, 0.5, -60),
            BackgroundColor3 = Color3.fromRGB(190, 220, 255),
    ...
    AddConnection(MinimizeBtn.MouseButton1Up, function()
        if Minimized then
            TweenService:Create(MainWindow, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2.new(0, 615, 0, 400)}):Play()
    ...
    function TabFunction:MakeTab(TabConfig)
        ...
        if FirstTab then
            ...
            TabFrame.Title.Font = Enum.Font.Arcade
        ...
        AddConnection(TabFrame.MouseButton1Click, function()
            for _, Tab in next, TabHolder:GetChildren() do
                if Tab:IsA("TextButton") then
                    Tab.Title.Font = Enum.Font.Arcade
    ...
    return Button
            ...
            function ElementFunction:AddToggle(ToggleConfig)
                ...
                function Toggle:Set(Value)
                    Toggle.Value = Value
                    TweenService:Create(ToggleBox, TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundTransparency = Toggle.Value and 0 or 0.85}):Play()
                    TweenService:Create(ToggleBox.Stroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Color = Toggle.Value and ToggleConfig.Color or OrionLib.Themes.Default.Stroke, Transparency = Toggle.Value and 0.3 or 0.8}):Play()
                ...
                AddConnection(Click.MouseEnter, function()
                    TweenService:Create(ToggleFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundTransparency = 0.5}):Play()
                end)
                ...
                AddConnection(Click.MouseButton1Down, function()
                    TweenService:Create(ToggleFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundTransparency = 0.4}):Play()
                end)
            ...
            function ElementFunction:AddBind(BindConfig)
                ...
                AddConnection(Click.MouseEnter, function()
                    TweenService:Create(BindFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundTransparency = 0.5}):Play()
                end)
                ...
                AddConnection(Click.MouseButton1Down, function()
                    TweenService:Create(BindFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundTransparency = 0.4}):Play()
                end)
            ...
            function ElementFunction:AddTextbox(TextboxConfig)
                ...
                AddConnection(Click.MouseEnter, function()
                    TweenService:Create(TextboxFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundTransparency = 0.5}):Play()
                end)
                ...
                AddConnection(Click.MouseButton1Down, function()
                    TweenService:Create(TextboxFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundTransparency = 0.4}):Play()
                end)
            end
